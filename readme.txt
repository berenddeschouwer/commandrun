...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\commandrun on
     Windows, /home/user/dev/commandrun on Linux) in a file named
     commandrun@banapple.de and copy that file to
